...
<div class="header">
  ...
  <div class="logininfo">
    <span class="welcome">
      <img src="<?php echo $this->_baseUrl?>/static/admin/images/user_edit.png" align="absmiddle"> 欢迎, <em>
        <?php echo $this->_admini['userName']?>
      </em>
      <em>###今天是
        <span style="color:green;"><?=date('Y');?></span>
          年中的
        <span style="color:red">第<?=date('W');?>周</span>
        ###</em>
    </span>
    <a href="<?php echo $this->createUrl('admin/ownerUpdate')?>" target="win">修改密码</a>
    <a href="<?php echo $this->createUrl('public/logout')?>" target="_top">退出登录</a>
    <a href="<?php echo Yii::app()->homeUrl?>" target="_blank">前台首页</a>
  </div>
