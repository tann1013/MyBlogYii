...
INSERT INTO `bage_admin` VALUES('1','admin','591c026bec348b9be6b6662148d46363','','1','tann1013@gmail.com','0','每个礼拜五推送精选WEB资讯---PHPclub;\n\n\n 注意更改涉及安全的数据','','','183.157.47.170','1516610139','361','Y','1409819170');
...
CREATE TABLE `bage_admin_logger` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=756 DEFAULT CHARSET=utf8 COMMENT='管理员日志';
...
INSERT INTO `bage_catalog` VALUES('18','0','每周笔记','每周技术博客','weeklythink','','','','','','','0','0','0','Y','N','','list','list_text','list_page','show_post','','','1487491955');
INSERT INTO `bage_catalog` VALUES('19','0','我的游记','mytravel','','','','','','','','1','0','0','Y','N','','list','list_text','list_page','show_post','','','1490152243');
...
INSERT INTO `bage_catalog` VALUES('11','0','PHP','php','php','php_list','','','','','','2','0','0','Y','N','','list','list_text','list_page','show_post','','','1414593100');
...
INSERT INTO `bage_config` VALUES('base','site_name','vandin\'s blog 谭建的网络记事本','');
...
INSERT INTO `bage_config` VALUES('base','seo_title','vandin Blog - 谭建的网络记事本','');
INSERT INTO `bage_config` VALUES('base','seo_description','vandin Blog - 谭建的网络记事本-记录个人生活和技术心得','');
INSERT INTO `bage_config` VALUES('base','seo_keywords','Vandin PHP  PHP博客  PHP技术 ','');
...
INSERT INTO `bage_config` VALUES('custom','_address','北京','');
...
CREATE TABLE `bage_post_2tags` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=96 DEFAULT CHARSET=utf8 COMMENT='内容关联标签';

INSERT INTO `bage_post_2tags` VALUES('84','95','支付宝');
INSERT INTO `bage_post_2tags` VALUES('85','95','如何');
INSERT INTO `bage_post_2tags` VALUES('86','94','今日事今日毕');
INSERT INTO `bage_post_2tags` VALUES('87','94','评估优先级');
INSERT INTO `bage_post_2tags` VALUES('88','94','日总结');
INSERT INTO `bage_post_2tags` VALUES('89','94','周总结');
INSERT INTO `bage_post_2tags` VALUES('90','94','平级沟通');
...
CREATE TABLE `bage_post_comment` (
  ...
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '录入时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='新闻评论';
...
CREATE TABLE `bage_post_tags` (
  ...
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '录入时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=94 DEFAULT CHARSET=utf8 COMMENT='新闻标签';
...
CREATE TABLE `bage_upload` (
  ...
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上传时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=50 DEFAULT CHARSET=utf8 COMMENT='附件';
...
INSERT INTO `bage_upload` VALUES('48','0','content','0','wuhan.jpg','uploads/201706/2484ce33b00d6de76595ef2fdce1bc30.jpg','','uploads/201706/','2484ce33b00d6de76595ef2fdce1bc30.jpg','7ff76fa7bea03b7973cd4023cf71c2a1','jpg','application/octet-stream','19913','0','','1497023713');
INSERT INTO `bage_upload` VALUES('49','0','content','0','hz.jpg','uploads/201706/a8e0b877a6b1e008ade4ef7e571c0fb4.jpg','','uploads/201706/','a8e0b877a6b1e008ade4ef7e571c0fb4.jpg','b43bce030ca049bcee05cc576cf63392','jpg','application/octet-stream','11307','0','','1497023800');
