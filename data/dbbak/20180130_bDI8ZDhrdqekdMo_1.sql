...
INSERT INTO `bage_admin` VALUES('1','admin','591c026bec348b9be6b6662148d46363','','1','tann1013@gmail.com','0','每个礼拜五推送精选WEB资讯---PHPclub;nnn 注意更改涉及安全的数据','','','183.156.41.106','1517318864','366','Y','1409819170');
...
CREATE TABLE `bage_admin_logger` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=787 DEFAULT CHARSET=utf8 COMMENT='管理员日志';
