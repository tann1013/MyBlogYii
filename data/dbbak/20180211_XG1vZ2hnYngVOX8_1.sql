...
INSERT INTO `bage_admin` VALUES('1','admin','591c026bec348b9be6b6662148d46363','','1','tann1013@gmail.com','0','每个礼拜五推送精选WEB资讯---PHPclub;nnn 注意更改涉及安全的数据','','','183.156.40.197','1518356448','379','Y','1409819170');
...
CREATE TABLE `bage_admin_logger` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=833 DEFAULT CHARSET=utf8 COMMENT='管理员日志';
...
CREATE TABLE `bage_upload` (
  ...
  `create_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上传时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COMMENT='附件';
